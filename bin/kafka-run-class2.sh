...
if [ -z "$KAFKA_JVM_PERFORMANCE_OPTS" ]; then
  KAFKA_JVM_PERFORMANCE_OPTS="-server -XX:+UseG1GC -XX:MaxGCPauseMillis=20 -XX:InitiatingHeapOccupancyPercent=35 -XX:+ExplicitGCInvokesConcurrent -XX:MaxInlineLevel=15 -Djava.awt.headless=true -XX:+PreserveFramePointer  -XX:+UseLinuxPosixThreadCPUClocks -agentpath:/home/hss544/profiler/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/hss544/profiler/lib,5140 -XX:+UseLinuxPosixThreadCPUClocks -agentpath:/home/hss544/profiler/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/hss544/profiler/lib,5140 -XX:+UseLinuxPosixThreadCPUClocks -agentpath:/home/hss544/profiler/lib/deployed/jdk16/linux-amd64/libprofilerinterface.so=/home/hss544/profiler/lib,5140"
fi
